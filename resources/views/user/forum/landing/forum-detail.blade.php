							...
							<div class="card-content">
								<div class="row" style="margin-bottom: 0">
									...
									<div class="col s12 m12 l12 hy-title-list">
										<ul class="collection user" style="border:0; overflow: inherit;">
									...
									<div class="col s12 m12 l12">
										<div class="sub-footer-hy-post row valign-wrapper-hy">
											<div class="col s12 m12 l6 suka valign">
												<span class="text-atr-komen" style="border: 1px solid #eee;padding: 0.5em 1em;border-radius: 8px;">
													<span style="font-weight: 600;font-size: 1.1rem">2</span><span style="font-size: 1rem"> Orang Menyukai</span>
												</span>
											</div>
											<div class="col s12 m12 l6 komentar">
												<span class="text-atr-komen" style="border: 1px solid #eee;padding: 0.5em 1em;border-radius: 8px;">
													<span style="font-weight: 600;font-size: 1.1rem">2</span><span style="font-size: 1rem"> Komentar</span>
												</span>
											</div>
										</div>
